...
import { Mail, Lock, Eye, EyeOff, MessageSquare, ArrowRight, Sparkles } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full bg-[#0B0F19] text-white flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      {/* Main Glass Card */}
      <div className="relative w-full max-w-md rounded-3xl bg-gray-900/70 border border-white/10 p-8 sm:p-10 shadow-2xl backdrop-blur-2xl animate-fade-in">
        {/* Brand Header */}
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400">
            Sign in to continue chatting, voice & video calling
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center">
          <p className="text-sm text-slate-400">
            ...
            <Link
              to="/register"
              className="text-emerald-400 hover:text-emerald-300 font-medium inline-flex items-center gap-1 hover:underline transition"
            >
